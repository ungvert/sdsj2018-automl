...
def select_features(X: pd.DataFrame, y: pd.Series, mode: str, 
    n_estimators: int=50, max_iter: int=30, perc: int=20) -> List[str]:
    ...
    feat_selector = BorutaPy(feat_estimator, n_estimators=n_estimators, 
    max_iter=max_iter, verbose=2, random_state=1, perc=perc)
